...
INSERT INTO BOOKING(ID, CHECK_IN, CHECK_OUT, GUESTS, AMOUNT, SERVICE_FEE, TOTAL, ID_USER, ID_ACCOMODATION, PAYMENT_ID) VALUES(1, DATE('2022-04-01'), DATE('2022-04-03'), 4, 200, 20, 220, 2, '0001234A', 1);
INSERT INTO BOOKING(ID, CHECK_IN, CHECK_OUT, GUESTS, AMOUNT, SERVICE_FEE, TOTAL, ID_USER, ID_ACCOMODATION, PAYMENT_ID) VALUES(2, DATE('2022-05-12'), DATE('2022-05-13'), 2, 233, 23.30, 256.30, 1, '0005678B', 2);
INSERT INTO BOOKING(ID, CHECK_IN, CHECK_OUT, GUESTS, AMOUNT, SERVICE_FEE, TOTAL,ID_USER, ID_ACCOMODATION, PAYMENT_ID) VALUES(3, DATE('2022-05-16'), DATE('2022-05-23'), 2, 99, 9.9, 108.9, 7, '0005678B', 2);
...
INSERT INTO BOOKING(ID, CHECK_IN, CHECK_OUT, GUESTS, AMOUNT, SERVICE_FEE, TOTAL,ID_USER, ID_ACCOMODATION, PAYMENT_ID) VALUES(5, DATE('2022-07-23'), DATE('2022-07-25'), 3, 335.65, 33.565, 369.215,  1, '0005678B', 1);
INSERT INTO BOOKING(ID, CHECK_IN, CHECK_OUT, GUESTS, AMOUNT, SERVICE_FEE, TOTAL,ID_USER, ID_ACCOMODATION, PAYMENT_ID) VALUES(6, DATE('2022-05-25'), DATE('2022-05-29'), 3, 500, 50, 550, 6, '0001234A', 1);
...
INSERT INTO SAVED_ACCOMODATION(ID, ID_USER, ID_ACC) VALUES(1, 2, '0001234A');
