...
INSERT INTO BOOKING(ID, CHECK_IN, CHECK_OUT, GUESTS, AMOUNT, ID_USER, ID_ACCOMODATION, PAYMENT_ID) VALUES(2, DATE('2022-05-12'), DATE('2022-05-13'), 2, 233, 1, '0001234A', 2);
INSERT INTO BOOKING(ID, CHECK_IN, CHECK_OUT, GUESTS, AMOUNT, ID_USER, ID_ACCOMODATION, PAYMENT_ID) VALUES(3, DATE('2022-05-16'), DATE('2022-05-23'), 2, 99, 3, '0001234A', 2);
INSERT INTO BOOKING(ID, CHECK_IN, CHECK_OUT, GUESTS, AMOUNT, ID_USER, ID_ACCOMODATION, PAYMENT_ID) VALUES(4, DATE('2022-06-01'), DATE('2022-06-14'), 1, 88, 2, '0001234A', 1);
INSERT INTO BOOKING(ID, CHECK_IN, CHECK_OUT, GUESTS, AMOUNT, ID_USER, ID_ACCOMODATION, PAYMENT_ID) VALUES(5, DATE('2022-07-23'), DATE('2022-07-25'), 3, 335.65, 3, '0001234A', 1);
INSERT INTO BOOKING(ID, CHECK_IN, CHECK_OUT, GUESTS, AMOUNT, ID_USER, ID_ACCOMODATION, PAYMENT_ID) VALUES(6, DATE('2022-05-25'), DATE('2022-05-29'), 3, 500, 1, '0001234A', 1);
